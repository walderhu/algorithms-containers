...
//   // Проверяем, что метод reserve не изменяет емкость, если новый размер
//   меньше
//   // текущей емкости
//   vec.reserve(5);
//   EXPECT_EQ(vec.capacity(), 20);
...
//   // Проверяем, что метод shrink_to_fit не изменяет емкость, если она уже
//   равна
//   // размеру вектора
//   vec.shrink_to_fit();
//   EXPECT_EQ(vec.capacity(), vec.size());
...
//   // // Проверяем, что итератор можно декрементировать и указывать на
//   последний
//   // элемент
//   // --it;
//   // EXPECT_EQ(*it, 4);
